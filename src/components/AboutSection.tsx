  ...
  return <section className="py-16 bg-background">
      <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 gap-6">
            <Card className="text-center p-6 bg-gradient-to-br from-owl-cream to-background border-border/50">
              <CardContent className="p-0 space-y-2">
                <div className="text-3xl font-bold text-owl-brown">2+</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => <Card key={index} className="text-center p-6 bg-card border-border/50 hover:border-owl-amber/50 hover:shadow-lg transition-all duration-300">
