  ...
  return (
    <>
      <Card className="group relative overflow-hidden bg-card hover:shadow-lg transition-all duration-300 border-border/50 hover:border-owl-amber/50 flex flex-col">
        ...
        <div 
          className="relative overflow-hidden bg-gradient-to-br from-owl-warm to-owl-cream cursor-pointer"
        ...
        <CardContent 
          className="p-4 space-y-3 flex-1 flex flex-col cursor-pointer"
          onClick={() => setShowModal(true)}
        >
          {/* Category */}
